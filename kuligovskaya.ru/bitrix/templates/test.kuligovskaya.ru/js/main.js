...
function OpenModal(id_form) {
  $('#' + id_form).toggleClass('active');
}

function CloseModal(id_form) {
  $('#' + id_form).removeClass('active');
}

$(function () {
  lazyload();
  $('.modal_form__wrap').on('click', function (event) {
  ...
  if ($(window).width() > 991) {
    ...
    var _swiper2 = new Swiper('#main-slider', {
      navigation: {
        nextEl: '.swiper-button-next',
        prevEl: '.swiper-button-prev'
      },
  ...
  var swiperGalleryIRP = new Swiper(".swiper_irp", {
    grabCursor: false,
    effect: "creative",
    spaceBetween: 20,
    pagination: {
      el: ".swiper-pagination_irp",
      type: "fraction",
      formatFractionCurrent: function formatFractionCurrent(number) {
        if (number < 10) {
          number = '0' + number;
    ...
    navigation: {
      nextEl: '.swiper-button-next_irp',
      prevEl: '.swiper-button-prev_irp'
    },
    creativeEffect: {
      prev: {
        shadow: false,
  ...
  var swiper = new Swiper(".photos_swiper_catalog", {
    pagination: {
      el: ".swiper-pagination"
    }
  });
  ...
  $('.tabs_ipr__nav li').on('click', function () {
    if (!$(this).hasClass('active')) {
      $('.tabs_ipr__nav li').removeClass('active');
      $(this).addClass('active');
      var index = $(this).index();
      $('.tabs_ipr__content').hide();
      $('.tabs_ipr__content').eq(index).fadeIn();
    }
  });
  $('.tabs_about_residential_complex__nav li').on('click', function () {
    if (!$(this).hasClass('active')) {
      $('.tabs_about_residential_complex__nav li').removeClass('active');
      $(this).addClass('active');
      var index = $(this).index();
      $('.tabs_about_residential_complex__content').hide();
      $('.tabs_about_residential_complex__content').eq(index).fadeIn();
    }
  });
  ...
  $('.faq__btn').on('click', function () {
    if (!$(this).hasClass('active')) {
      ...
      $(this).addClass('active');
      $(this).closest('.faq__row').find('.faq__body').slideDown(300);
    } else {
      $('.faq__btn').removeClass('active');
      $('.faq__body').slideUp(300);
    }
