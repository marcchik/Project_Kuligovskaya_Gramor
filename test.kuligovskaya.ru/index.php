                ...
                <div class="company__wrap">
                    <div class="company__left">
                        ...
                        <div class="company__media">
                            <a href="/bitrix/templates/test.kuligovskaya.ru/img/main/company1.jpg" class="lazyload company__media__img"
                               data-fslightbox="gallery" data-src="./img/main/company1.jpg"></a>
                            <a href="/bitrix/templates/test.kuligovskaya.ru/video/1.mp4" data-fslightbox="gallery2"
                               data-video-poster="https://fslightbox.com/img/bbunny.png" class="company__media__video"
                               style="background-image: url(/bitrix/templates/test.kuligovskaya.ru/img/main/company2.jpg)">
                                    <span>
                                ...
                                <div class="company__list__item">
                                    <div class="company__list__cross">
                                        <svg width="14.5" height="14.5">
                                            <use xlink:href="/bitrix/templates/test.kuligovskaya.ru/img/sprite.svg#cross"></use>
                                        </svg>
                                    </div>
                                    14 работы
